...
export declare function getParams(params: ParamMetadata[], resolverData: ResolverData<any>, globalValidate: ValidateSettings, validateFn: ValidatorFn<object> | undefined, pubSub: PubSubEngine): Promise<any[]> | any[];
