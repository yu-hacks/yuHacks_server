...
function getParams(params, resolverData, globalValidate, validateFn, pubSub) {
    const paramValues = params
        ...
        switch (paramInfo.kind) {
            case "args":
                return (0, validate_arg_1.validateArg)((0, convert_args_1.convertArgsToInstance)(paramInfo, resolverData.args), paramInfo.getType(), globalValidate, paramInfo.validate, validateFn);
            case "arg":
                return (0, validate_arg_1.validateArg)((0, convert_args_1.convertArgToInstance)(paramInfo, resolverData.args), paramInfo.getType(), globalValidate, paramInfo.validate, validateFn);
            case "context":
