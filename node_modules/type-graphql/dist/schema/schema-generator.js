    ...
    static buildTypesInfo(resolvers) {
        ...
        this.objectTypesInfo = (0, getMetadataStorage_1.getMetadataStorage)().objectTypes.map(objectType => {
            ...
            const getSuperClassType = () => {
                var _a;
                const superClassTypeInfo = (_a = this.objectTypesInfo.find(type => type.target === objectSuperClass)) !== null && _a !== void 0 ? _a : this.interfaceTypesInfo.find(type => type.target === objectSuperClass);
